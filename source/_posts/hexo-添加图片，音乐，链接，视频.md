...
# 3.音乐
大家可以看[网易云音乐](http://music.163.com/)的官网，播放音乐可以生成外链，直接拿来用就行了。iframe插件可以在代码中设置宽高等参数，auto为自动播放。flash不可以自己设置参数。看喜好，随便你。
...
```
[我的微博](http://weibo.com/u/5967841127)
```
[我的微博](http://weibo.com/u/5967841127)
...
[极简图床不错](http://jiantuku.com/#/)
[小贱贱图床](https://pic.xiaojianjian.net/)
[SM.SMb不错](https://sm.ms/)
